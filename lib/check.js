...
module.exports = function (options, callback) {
  ...
  if (options.exceptions) {
    options.exceptions = options.exceptions.map(function (exception) {

      if (exception.indexOf('https://nodesecurity.io/advisories/') <= -1) {
        exception = 'https://nodesecurity.io/advisories/' + exception;
      }
      return exception;
    });
  }
